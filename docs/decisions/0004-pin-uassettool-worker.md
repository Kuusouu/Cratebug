...
| Release tag | `v1.5.8` |
| Target branch | `main` |
| Source revision (commit) | `05470f4634533437897647c93448b6d5de02d09a` |
| Release asset | `UAssetTool-win-x64.zip` |
| Asset size | 31,799,861 bytes (~30.3 MB) |
| SHA-256 | `419bb2bb974fc7434366dbcdace74c5a2fa1ca81872a12ef7d5fdc458454395a` |
| Published | 2026-09-07T09:58:25Z |
| Worker's own reported version | `UAssetTool v1.5.8+05470f4634533437897647c93448b6d5de02d09a` |
...
- `gh release view v1.5.8 --repo mewclouds/UAssetToolRivals --json tagName,publishedAt,targetCommitish,assets` (release metadata and asset digest, checked 2026-09-07)
